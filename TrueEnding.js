document.addEventListener("DOMContentLoaded", function () {
    ...
    textContainer.style.lineHeight = "2";  // Spacing between lines
    ...
    const displayTimes = {};
    messages.forEach(msg => displayTimes[msg] = 2000); // Set default to 2000ms

    // Override specific messages with custom times
    displayTimes["..."] = 5000;
    displayTimes["Bye."] = 180000; // 3 minutes pause
    displayTimes["And I can see you, you know. Every movement. Every hesitation. Every time your mouse hovers over that button, debating whether or not to leave. But you won’t, will you? Because you’re waiting for something. You want to know what happens next."] = 14000;
    displayTimes["I wonder... do you even remember how you got here? It doesn’t matter. You’ll never leave the same way you entered."] = 8000;
    displayTimes["I gave you every opportunity, every chance to escape. Every single warning."] = 6000;
    displayTimes["However, everything has a silver lining, unfortunately."] = 7000;

    let index = 0;

    function showNextText() {
        if (index < messages.length) {
            textContainer.textContent = messages[index]; // Replace previous text
            let delay = displayTimes[messages[index]];
            index++;
